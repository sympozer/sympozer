...
angular.module('notificationsApp').controller('notificationsListCtrl', ['$scope', '$filter', function ($scope, $filter)
{
   ...
   */
  $scope.notifications = [
    { text: 'Notification 1', time: '4m', class: 'notification-success', iconClasses: 'fa fa-check', seen: true },
    { text: 'Notification 2', time: '10m', class: 'notification-user', iconClasses: 'fa fa-user', seen: false },
  ];
