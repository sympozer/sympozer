 ...
 * @type {controller}
 */
angular.module('papersApp').controller('papersCommunityListCtrl', ['$scope', '$routeParams', 'GLOBAL_CONFIG', 'createDialog', '$rootScope', 'papersFact', '$cachedResource', function ($scope, $routeParams, GLOBAL_CONFIG, createDialogService, $rootScope, papersFact, $cachedResource)
{
