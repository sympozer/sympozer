...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      'release-complete': [
        'git commit CHANGELOG.md package.old.json -m "chore(release): v%version%"',
        'git tag %version%'
      ],
      'release-start': [
        'grunt version:minor:"SNAPSHOT"',
        'git commit package.old.json -m "chore(release): Starting v%version%"'
      ]
    },
    ngdocs: {
      options: {
