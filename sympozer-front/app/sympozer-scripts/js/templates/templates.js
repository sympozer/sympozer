/**
 * Configurations for modal, panel, tiles... templates (loading in cache)
 * @TODO: Find a better way to manage these templates
 * @type {config}
 */
angular.module('sympozerApp').run(['$templateCache', function ($templateCache)
{
    'use strict';
