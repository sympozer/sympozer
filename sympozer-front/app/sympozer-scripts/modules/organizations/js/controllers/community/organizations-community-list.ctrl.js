 ...
 * @type {controller}
 */
angular.module('organizationsApp').controller('organizationsCommunityListCtrl', ['$scope', '$routeParams', 'GLOBAL_CONFIG', 'createDialog', '$rootScope', 'organizationsFact', '$cachedResource', function ($scope, $routeParams, GLOBAL_CONFIG, createDialogService, $rootScope, organizationsFact, $cachedResource)
{
